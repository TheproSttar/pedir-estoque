import { EmbedBuilder, StringSelectMenuBuilder, ActionRowBuilder, RoleSelectMenuInteraction } from "discord.js";

export async function embedConfigBotRole(interaction: RoleSelectMenuInteraction) {
