import { EmbedBuilder, StringSelectMenuBuilder, ActionRowBuilder, ChannelSelectMenuInteraction } from "discord.js";

export async function embedConfigBot(interaction: ChannelSelectMenuInteraction) {
